...
Create a programme that displays the following menu:
...
If you select 3, the program asks you to enter the list number of an item to delete. It deletes the specified item 
from the list.

If you select 4, the program asks you to enter the list number of an item to change, then asks you to enter text. 
It changes the specified item to the specified text.
...
def show_menu():
    options = ["Display the database", "Add an item", "Change an item", "Delete an item", "Quit"]
...
def main():
    db = ["apple", "orange", "blackberry", "pear", "lychee", "strawberry", "lemon"]
